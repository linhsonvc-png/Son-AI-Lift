# AnhBABao ESP32 Web Flasher

A web-based tool for flashing firmware to ESP32 microcontrollers directly from your browser using the Web Serial API.

Have a look: [AnhBABao ESP32 Web Flasher](https://linhsonvc-png.github.io/flasher-anhba/)

Created by: [AnhBABao](https://github.com/linhsonvc-png) 
## Features
...
Customized by AnhBABao from the original ESP32 Web Flasher project.
